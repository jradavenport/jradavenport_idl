...
;     TVIMAGE
;
; ----- NOTE: This is an old version from D. Fanning, frozen for use
;             in SIMPLEPHOT (J.R.A. Davenport, 2015)
;
;
; PURPOSE:
...
PRO TVIMAGE_simple, image, KEEP_ASPECT_RATIO=keep, POSITION=position, $
